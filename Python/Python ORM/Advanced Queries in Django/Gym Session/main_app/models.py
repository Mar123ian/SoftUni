...
class Exercise(models.Model):
    ...
    def get_exercises_within_duration(min_duration: int, max_duration: int):
        return Exercise.objects.filter(duration_minutes__gte=min_duration, duration_minutes__lte=max_duration)

    @staticmethod
    def get_exercises_with_difficulty_and_repetitions(min_difficulty: int, min_repetitions: int):
        return Exercise.objects.filter(difficulty_level__gte=min_difficulty, repetitions__gte=min_repetitions)
