...
document2 = Document.objects.create( title="Django Framework 2", content="Django framework provides tools for creating web pages, handling URL routing, and more.", )
...
# Print the search results. for result in results: print(f"Title: {result.title}")